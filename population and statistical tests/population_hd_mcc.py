...
if not os.path.exists('plots_heart_disease'):
    os.makedirs('plots_heart_disease')
...
for var in categorical_vars:
    p = chi_square_test(data, var, 'num_binary')
